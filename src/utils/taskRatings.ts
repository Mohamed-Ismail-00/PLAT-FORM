...
/**
 * Converts old five-point task ratings to the new ten-point scale once.
 * New records carry rating_scale=10, so a manually entered 5/10 is never
 * mistaken for a legacy 5/5 rating.
 */
